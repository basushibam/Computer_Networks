...
int main(int argc, char const *argv[])
{
    ...
    while(1)
    {
        ...
        recvfrom(rsfd,buffer,100,0,(sockaddr*)&cli_addr,&size);
        sockaddr_in newaddr; socklen_t len; 
        //getpeername(rsfd,(struct sockaddr*)&newaddr,&len);
        //printf("Using getpeername message received from -----------------\n");
